...
const swaggerDefinition = {
	...
	info: {
		...
		version: "1.0",
		description:
			"Welcome to the documentation of the API that allows you to create a grocery list",
		contact: {
	...
	tags: [
		...
		},
		{
			name: "Category",
			description:
				"Personnal category = the category of an item corresponding on how you sort it",
		},
		{
			name: "Shelf",
			description:
				"The shelf where you can find an item in your favorite store",
		},
	],
	paths,
	components,
